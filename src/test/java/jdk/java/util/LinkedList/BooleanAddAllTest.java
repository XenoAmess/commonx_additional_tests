...
public class BooleanAddAllTest {
    @Test
    public void main() {
        List head = Collections.nCopies(7, true);
        List tail = Collections.nCopies(4, true);
        BooleanList l1 = new BooleanArrayList(head);
        BooleanList l2 = new BooleanLinkedList(head);
        l1.addAll(tail);
        l2.addAll(tail);
        if (!l1.equals(l2))
