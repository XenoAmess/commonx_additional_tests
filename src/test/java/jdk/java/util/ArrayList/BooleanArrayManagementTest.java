...
public class BooleanArrayManagementTest {
    ...
    static {
        try {
            ELEMENT_DATA = BooleanArrayList.class.getDeclaredField("elementData");
            ELEMENT_DATA.setAccessible(true);
            MODCOUNT = AbstractBooleanList.class.getDeclaredField("modCount");
    ...
    static boolean[] elementData(BooleanArrayList list) {
        try {
            return (boolean[]) ELEMENT_DATA.get(list);
        } catch (ReflectiveOperationException huh) {
            throw new AssertionError(huh);
        }
    }

    static int modCount(BooleanArrayList list) {
        try {
    ...
    static int capacity(BooleanArrayList list) {
    ...
    static void ensureCapacity(BooleanArrayList list, int capacity) {
    ...
    public void emptyArraysAreShared() {
        assertSame(elementData(new BooleanArrayList()),
                elementData(new BooleanArrayList()));
        assertSame(elementData(new BooleanArrayList(0)),
                elementData(new BooleanArrayList(0)));
    }

    @Test
    public void emptyArraysDifferBetweenDefaultAndExplicit() {
        assertNotSame(elementData(new BooleanArrayList()),
                elementData(new BooleanArrayList(0)));
    }
