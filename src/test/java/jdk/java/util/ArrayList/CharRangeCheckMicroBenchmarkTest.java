...
public class CharRangeCheckMicroBenchmarkTest {
    ...
    private static void time(Job... jobs) throws Throwable {
        ...
        float[] ratios = new float[jobs.length];
        ...
        for (int i = 0; i < jobs.length; i++) {
            ...
            ratios[i] = (float) ((char) nanoss[i] / (char) nanoss[0]);
    ...
    private static void deoptimize(CharArrayList list) {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        final Job[] jobs = {
                ...
                new Job("set") {
                    void work() {
                        Character[] xs = list.toArray(new Character[size]);
                        for (int i = 0; i < iterations; i++) {
                            for (int k = 0; k < size; k++)
                                list.set(k, xs[k]);
                        }
                ...
                new Job("subList get") {
                    void work() {
                        CharList sublist = list.subList(0, list.size());
                        for (int i = 0; i < iterations; i++) {
                            for (int k = 0; k < size; k++)
                                if (sublist.get(k) == 42)
                                    throw new Error();
                ...
                new Job("subList set") {
                    void work() {
                        CharList sublist = list.subList(0, list.size());
                        Character[] xs = sublist.toArray(new Character[size]);
                        for (int i = 0; i < iterations; i++) {
                            for (int k = 0; k < size; k++)
                                sublist.set(k, xs[k]);
                        }
